...
namespace Lidgren.Network
{
	...
	public partial class NetPeer
	{
		...
		/// <summary>
		/// Custom net game configuration used to differentiate IP Protocols.
		/// </summary>
		public NetGameConfiguration NetGameConfiguration { get; protected set; }
		...
		//OneThumb additional custom code.
		public int OutstandingIncomingMessages()
		{
			return m_releasedIncomingMessages.Count;
		}
		//OneThumb additional custom code.
	}
}
